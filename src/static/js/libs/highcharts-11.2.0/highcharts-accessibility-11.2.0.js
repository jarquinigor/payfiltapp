 ...
 */ !(function (t) {
  "object" == typeof module && module.exports
    ...
    ? define("highcharts/modules/accessibility", ["highcharts"], function (e) {
  ...
  i(
        ...
        return (
          (function (t) {
            ...
            function r(t, e, i) {
              ...
              do
                (l = r(t, c)),
                  (h = t.substring(c, l && l.begin - 1)).length &&
                ...
                a.forEach((t) => {
                  "statement" === t.type &&
                    (t.value = (function (t, e) {
                      let i, s;
                      let r = t.indexOf("#each("),
                        a = t.indexOf("#plural("),
                        l = t.indexOf("["),
                        h = t.indexOf("]");
                      if (r > -1) {
                        let o = t.slice(r).indexOf(")") + r,
                          a = t.substring(0, r),
                          l = t.substring(o + 1),
                          h = t.substring(r + 6, o),
                          c = h.split(","),
                        ...
                        if (((s = ""), (i = n(c[0], e)))) {
                          u =
                            (d = isNaN(d) ? i.length : d) < 0
                              ? i.length + d
                              : Math.min(d, i.length);
                          for (let t = 0; t < u; ++t) s += a + i[t] + l;
                        }
                        return s.length ? s : "";
                      }
                      if (a > -1) {
                        var c;
                        let i = t.slice(a).indexOf(")") + a,
                          r = t.substring(a + 8, i),
                          l = r.split(","),
                          h = Number(n(l[0], e));
                        switch (h) {
                      ...
                      if (l > -1) {
                        let s;
                        let o = t.substring(0, l),
                          r = Number(t.substring(l + 1, h));
                        return (
                          (i = n(o, e)),
                          !isNaN(r) &&
                            i &&
            ...
            function a(t, e) {
              let i = t.split("."),
                s = this.options.lang,
                n = 0;
              for (; n < i.length; ++n) s = s && s[i[n]];
              return "string" == typeof s ? r(s, e, this) : "";
            }
        ...
        return {
          ...
          getChartTitle: function (t) {
            return n(
              t.options.title.text ||
                t.langFormat("accessibility.defaultChartTitle", { chart: t }),
          ...
          getAxisRangeDescription: function (t) {
            ...
            return e.accessibility &&
              ...
              ? (function (t) {
                  ...
                  return e.langFormat("accessibility.axis.timeRange" + o, {
                    chart: e,
                    axis: t,
                    range: r.replace(".0", ""),
                  });
          ...
          scrollAxisToPoint: function (t) {
            ...
            if (n && o(n.to) && o(n.from)) {
              let e = n.to - n.from,
                i = (function (t, e) {
                  if (!o(t.dataMin) || !o(t.dataMax)) return 0;
    ...
    i(
      ...
      function (t, e) {
        ...
        return class {
          ...
          removeAddedEvents() {
            this.eventRemovers.forEach((t) => t()), (this.eventRemovers = []);
          }
        };
      }
    ),
        ...
        return class {
          ...
          run(t) {
            ...
            return (
              n
                ? (s = n[1].call(this, i, t))
                : 9 === i && (s = this.response[t.shiftKey ? "prev" : "next"]),
              s
            );
          }
        };
        ...
        return class extends t {
          ...
          handleSVGTitleElement() {
            ...
            if (i.length) {
              ...
              (s.textContent = i),
                (s.id = e),
                t.renderTo.insertBefore(s, t.renderTo.firstChild);
            }
          }
          ...
          setRenderToAttrs() {
            let t = this.chart,
              e = "disabled" !== t.options.accessibility.landmarkVerbosity,
              i = t.langFormat("accessibility.chartContainerLabel", {
                title: r(t),
                chart: t,
              });
            i &&
              (t.renderTo.setAttribute("role", e ? "region" : "group"),
              ...
              (e.textStr &&
                e.element.setAttribute(
                  ...
                  t.langFormat("accessibility.credits", {
                    creditsStr: l(e.textStr, t.renderer.forExport),
                  })
                ),
              o(t, e.element));
          }
      ...
      function (t) {
        ...
        return (
          (function (e) {
            ...
            function a(t, e) {
              let s = this.options.accessibility.keyboardNavigation.focusBorder,
                n = e || t.element;
              n &&
                n.focus &&
            ...
            function l(t, e) {
              ...
              (i.x += this.translateX ? this.translateX : 0),
                (i.y += this.translateY ? this.translateY : 0);
              let d = i.x - n,
                u = i.y - n,
                p = i.width + 2 * n,
                g = i.height + 2 * n,
              ...
              if ("text" === this.element.nodeName || m) {
                ...
                let s = !!this.rotation,
                  ...
                  a = +this.attr("y");
                if (
                  (isNaN(r) || (d = r - i.width * o.x - n),
                  isNaN(a) || (u = a - i.height * o.y - n),
                  m && s)
                ) {
                  let t = p;
                  (p = g),
                    (g = t),
                    isNaN(r) || (d = r - i.height * o.x - n),
                    isNaN(a) || (u = a - i.width * o.y - n);
                }
              }
              (this.focusBorder = this.renderer
                .rect(
                  ...
                  p,
                  g,
                  parseInt(((e && e.r) || 0).toString(), 10) / c
                )
                ...
                this.renderer.styledMode ||
                  this.focusBorder.attr({
                    stroke: e && e.stroke,
                    "stroke-width": ((e && e.strokeWidth) || 0) / c,
                  }),
                (function (t, ...e) {
                  t.focusBorderUpdateHooks ||
                    ...
                    o.forEach((i) => {
                      ...
                      (t.focusBorderUpdateHooks[s] = n),
                        (t[s] = function () {
                          let i = n.apply(t, arguments);
                          return t.addFocusBorder.apply(t, e), i;
                        });
                    }));
                })(this, t, e),
                (function (t) {
            ...
            function h() {
              ...
              (t = this),
                t.focusBorderUpdateHooks &&
                  (Object.keys(t.focusBorderUpdateHooks).forEach((e) => {
            ...
            e.compose = function (e, i) {
              if (t.pushUnique(n, e)) {
                let t = e.prototype;
                (t.renderFocusBorder = r), (t.setFocusToElement = a);
              }
              if (t.pushUnique(n, i)) {
                let t = i.prototype;
                (t.addFocusBorder = l), (t.removeFocusBorder = h);
              }
            };
          })(e || (e = {})),
          e
      ...
      function (t, e, i, s, n) {
        ...
        return class {
          ...
          announce(e) {
            t.setElementHTML(this.announceRegion, e),
              ...
              (this.clearAnnouncementRegionTimer = setTimeout(() => {
                (this.announceRegion.innerHTML = t.emptyHTML),
          ...
          addAnnounceRegion(t) {
            ...
            return (
              l(i, { "aria-hidden": !1, "aria-live": t, "aria-atomic": !0 }),
              this.chart.styledMode ? r(i, "highcharts-visually-hidden") : a(i),
              e.appendChild(i),
              i
            );
          }
    ...
    i(
      ...
      function (t) {
        ...
        function s(t) {
          ...
          return e.reduce(
            (t, e) => (
              e.options && !1 !== e.options.visible && (t = t.concat(e.labels)),
              t
            ),
            []
          );
      ...
      function (t, e, i, s, n, o, r, a, l, h) {
        ...
        return class extends e {
            ...
            this.initRegionsDefinitions(),
              ...
              this.addEvent(t, "afterHideData", function () {
                e.viewDataTableButton &&
                  e.viewDataTableButton.setAttribute("aria-expanded", "false");
              }),
            ...
            this.screenReaderSections = {
              before: {
                ...
                buildContent: function (i) {
                  let s = e.screenReaderSection.beforeChartFormatter;
                  return s ? s(i) : t.defaultBeforeChartFormatter(i);
                },
              ...
              after: {
                element: null,
                buildContent: function (i) {
                  let s = e.screenReaderSection.afterChartFormatter;
                  return s ? s(i) : t.defaultAfterChartFormatter();
                },
                insertIntoDOM: function (t, e) {
          ...
          updateScreenReaderSection(t) {
            ...
            s
              ? (this.setScreenReaderSectionAttribs(o, t),
                ...
                o.appendChild(r),
                i.insertIntoDOM(o, e),
                e.styledMode ? f(r, "highcharts-visually-hidden") : A(r),
                g(e, r),
          ...
          defaultBeforeChartFormatter() {
            let e = this.chart,
              i = e.options.accessibility.screenReaderSection.beforeChartFormat;
            if (!i) return "";
            let s = this.getAxesDescription(),
              ...
              h = {
                ...
                viewTableButton: e.getCSV ? this.getDataTableButtonText(r) : "",
                annotationsTitle: a ? l : "",
                annotationsList: a,
              },
              d = t.i18nFormat(i, h, e);
            return (
              (this.dataTableButtonId = r), (this.sonifyButtonId = o), E(d)
            );
          }
          defaultAfterChartFormatter() {
            let e = this.chart,
              i = e.options.accessibility.screenReaderSection.afterChartFormat;
            if (!i) return "";
              ...
              ? t.options.accessibility.typeDescription ||
                  (function (t, e) {
                    let i = e[0],
                      ...
                      n =
                        t.mapView && t.mapView.geoMap && t.mapView.geoMap.title,
                      o = {
                    ...
                    return i
                      ...
                      : t.langFormat("accessibility.chartTypes.emptyChart", o);
                  })(t, t.types)
              : "";
          }
          ...
          getSonifyButtonText(t) {
            let e = this.chart;
            if (e.options.sonification && !1 === e.options.sonification.enabled)
              return "";
            let i = e.langFormat(
          ...
          getSubtitleText() {
            ...
            return v((t && t.text) || "", this.chart.renderer.forExport);
          }
    ...
    i(
      ...
      function (t, e, i, s, n, o) {
        let { attr: r } = e,
          { getChartTitle: a, unhideChartElementFromAT: l } = n,
        ...
        class d extends i {
          ...
          onMenuShown() {
            ...
            e && (this.addAccessibleContextMenuAttribs(), l(t, e)),
          ...
          onChartRender() {
            ...
            this.proxyProvider.clearGroup("chartMenu"),
              ...
              this.exportButtonProxy &&
                ...
                e === t.exportingGroup &&
                (e.focusBorder
                  ? t.setFocusToElement(e, this.exportButtonProxy.innerElement)
          ...
          createProxyGroup() {
            let t = this.chart;
            t && this.proxyProvider && this.proxyProvider.addGroup("chartMenu");
          }
          ...
          getKeyboardNavigation() {
            ...
            return new s(e, {
              ...
              init: function () {
                ...
                t && s && e.setFocusToElement(s, t.innerElement);
              },
              terminate: function () {
                e.hideExportMenu();
              },
          ...
          onKbdPrevious(t) {
            ...
            for (; n--; ) if (e.highlightExportItem(n)) return s.success;
          ...
          onKbdClick(t) {
            ...
            return (
              e.openMenu
                ...
                : (this.fakeClickEvent(s), e.highlightExportItem(0)),
              t.response.success
            );
          }
        }
        return (
          (function (i) {
            ...
            function r(t) {
              let e = this.exportDivElements && this.exportDivElements[t],
                i =
              ...
              if (
                ...
                return (
                  e.focus && s && e.focus(),
                  i && i.onmouseout && i.onmouseout(h("mouseout")),
                  e.onmouseover && e.onmouseover(h("mouseover")),
            ...
            function a() {
              if (this.exportDivElements) {
                ...
                for (; t--; ) if (this.highlightExportItem(t)) return !0;
              }
              return !1;
            }
            i.compose = function (i) {
              if (e.pushUnique(s, i)) {
                let e = t.prototype;
                (e.hideExportMenu = o),
                  (e.highlightExportItem = r),
                  (e.highlightLastExportItem = a),
                  (e.showExportMenu = n);
              }
            };
          })(d || (d = {})),
    ...
    i(
      ...
      function (t, e, i, s, n) {
        let { doc: o, win: r } = t,
          { addEvent: a, fireEvent: l } = i,
          { getElement: h, simulatedEventTarget: c } = n;
        class d {
          constructor(t, e) {
            (this.chart = void 0),
          ...
          init(t, e) {
            ...
            (this.chart = t),
              ...
              ["mouseup", "touchend"].forEach((t) =>
                i.addEvent(o, t, (t) => this.onMouseUp(t))
              ),
          ...
          move(t) {
            let e = this.modules && this.modules[this.currentModuleIx];
            ...
            if (i) {
              if (i.validate && !i.validate()) return this.move(t);
          ...
          onFocus(t) {
            let e = this.chart,
              i = t.relatedTarget && e.container.contains(t.relatedTarget),
            ...
            if (
              ...
              null !== t &&
                ((this.currentModuleIx = t), this.modules[t].init(1));
            }
            this.exiting = !1;
          }
          onMouseUp(t) {
            if (
              ...
              !this.keyboardReset && t.relatedTarget !== c)
            ) {
              let e = this.chart;
              if (!t.target || !e.container.contains(t.target)) {
                let t = this.modules && this.modules[this.currentModuleIx || 0];
                t && t.terminate && t.terminate(), (this.currentModuleIx = 0);
              }
              e.focusElement &&
                (e.focusElement.removeFocusBorder(), delete e.focusElement),
          ...
          createExitAnchor() {
            let t = this.chart,
              e = (this.exitAnchor = o.createElement("div"));
            t.renderTo.appendChild(e), this.makeElementAnExitAnchor(e);
          }
          makeElementAnExitAnchor(t) {
            let e = this.tabindexContainer.getAttribute("tabindex") || 0;
          ...
          addExitAnchorEventsToEl(t) {
            ...
            this.eventProvider.addEvent(t, "focus", function (t) {
              let s = t || r.event,
                n = s.relatedTarget && e.container.contains(s.relatedTarget),
                o = !(n || i.exiting);
          ...
          (function (s) {
            ...
            function r() {
              ...
              l(this, "dismissPopupContent", {}, function () {
                t.tooltip && t.tooltip.hide(0), t.hideExportMenu();
              });
            }
            function h(e) {
            ...
            s.compose = function (t) {
              if ((e.compose(t), i.pushUnique(n, t))) {
                let e = t.prototype;
                e.dismissPopupContent = r;
              }
              return i.pushUnique(n, o) && a(o, "keydown", h), t;
            };
          })(d || (d = {})),
          d
        );
    ...
    i(
      ...
      function (t, e, i, s, n, o, r, a) {
        let { animObject: l } = t,
          ...
          { getChartTitle: m } = r,
          { stripHTMLTagsFromString: b, addClass: f, removeClass: x } = a;
        function y(t) {
          let e = t.legend && t.legend.allItems,
            i = t.options.legend.accessibility || {},
            s =
              t.colorAxis &&
              t.colorAxis.some((t) => !t.dataClasses || !t.dataClasses.length);
        ...
        class A extends n {
          ...
          init() {
            ...
            this.recreateProxies(),
              this.addEvent(i, "afterScroll", function () {
                this.chart === t.chart &&
                  (t.proxyProvider.updateGroupProxyElementPositions("legend"),
            ...
            s.forEach((s) => {
              if (s.a11yProxyElement) {
                ...
                if (((t = s.legendItem || {}), r)) {
                  let e = t.pageIx || 0,
                    s = t.y || 0,
                    r = t.label ? Math.round(t.label.getBBox().height) : 0;
                ...
                l
                  ...
                  : (x(a, "highcharts-a11y-invisible"),
                    (a.style.visibility = ""));
              }
            });
          }
          onChartRender() {
            y(this.chart) || this.removeProxies();
          }
          ...
          updateProxyPositionForItem(t) {
            t.a11yProxyElement && t.a11yProxyElement.refreshPosition();
          }
          recreateProxies() {
            let t = h.activeElement,
              e = this.proxyGroup,
              i = t && e && e.contains(t);
            return (
              this.removeProxies(),
          ...
          updateLegendTitle() {
            let t = this.chart,
              ...
              i = t.langFormat(
                ...
                { chart: t, legendTitle: e, chartTitle: m(t) }
              );
          ...
          proxyLegendItem(t) {
            ...
            let i = this.chart.langFormat("accessibility.legend.legendItem", {
                chart: this.chart,
                itemName: b(t.name, this.chart.renderer.forExport),
                item: t,
              }),
              s = { tabindex: -1, "aria-pressed": t.visible, "aria-label": i },
          ...
          getKeyboardNavigation() {
            ...
            return new o(i, {
              keyCodeMap: [
                ...
                [
                  ...
                  function (i) {
                    ...
                    return (
                      e.highlightAdjacentLegendPage(s), this.response.success
                    );
                  },
                ],
              ],
              ...
              init: function () {
                i.highlightLegendItem(0), (e.highlightedLegendItemIx = 0);
              },
              terminate: function () {
                (e.highlightedLegendItemIx = -1),
                  i.legend.allItems.forEach((t) => v(!1, t));
              },
            });
          }
          onKbdArrowKey(t, e) {
            let i = this.keyCodes,
              s = t.response,
              n = this.chart,
              o = n.options.accessibility,
              r = n.legend.allItems.length,
              a = e === i.left || e === i.up ? -1 : 1,
              l = n.highlightLegendItem(this.highlightedLegendItemIx + a);
            return (
              l
                ? (this.highlightedLegendItemIx += a)
                : r > 1 && o.keyboardNavigation.wrapAround && t.init(a),
              s.success
            );
          }
          onKbdClick(t) {
            let e = this.chart.legend.allItems[this.highlightedLegendItemIx];
            return (
              e && e.a11yProxyElement && e.a11yProxyElement.click(),
              t.response.success
            );
          }
          shouldHaveLegendNavigation() {
            if (!y(this.chart)) return !1;
            let t = this.chart,
              e = t.options.legend || {},
              i = e.accessibility || {};
            return !!(
          ...
          (function (t) {
            ...
            function i(t) {
              ...
              if (s) {
                u(i) && e[i] && v(!1, e[i]),
                  (function (t, e) {
                    let i = (t.allItems[e].legendItem || {}).pageIx,
                      s = t.currentPage;
                    void 0 !== i && i + 1 !== s && t.scroll(1 + i - s);
                  })(this.legend, t);
                let o = n.label,
            ...
            t.compose = function (t, o) {
              if (s.pushUnique(e, t)) {
                let e = t.prototype;
                e.highlightLegendItem = i;
              }
              s.pushUnique(e, o) && c(o, "afterColorizeItem", n);
            };
          })(A || (A = {})),
          A
        );
      ...
      function (t, e) {
        ...
        function c(t) {
          let e = this.chart,
            ...
            l = s.rangeSelector,
            h = e.zooming.type;
          if (this.isXAxis && ((n && n.enabled) || (l && l.enabled))) {
            if ("y" === h) t.zoomed = !1;
            else if (
              ((!i && "xy" === h) || (i && "xy" === a)) &&
              this.options.range
        ...
        class d {
          ...
          toFixedRange(t, e, i, s) {
            let l = this.axis,
              h = l.chart,
              c = a(i, l.translate(t, !0, !l.horiz)),
              d = a(s, l.translate(e, !0, !l.horiz)),
              u = h && h.fixedRange,
              p = (l.pointRange || 0) / 2;
            return (
              o(i) || (c = n(c + p)),
              ...
              u &&
                l.dataMin &&
                l.dataMax &&
                (d >= l.dataMax && (c = n(l.dataMax - u)),
                c <= l.dataMin && (d = n(l.dataMin + u))),
              (r(c) && r(d)) || (c = d = void 0),
              { min: c, max: d }
            );
          }
    ...
    i(
      ...
      function (t, e, i, s, n, o, r) {
        ...
        let { defaultOptions: l, setOptions: h } = t,
          { isTouchDevice: c } = e,
          { getRendererType: d } = o,
          { addEvent: u, extend: p, merge: g, pick: m } = r,
          b = [];
        function f() {
        ...
        function x() {
          ...
          if (n) {
            ...
            this.inverted
              ...
              : ((n.left = m(e.left, this.plotLeft + r)),
                (n.top =
        ...
        function y(t) {
          !this.navigator &&
            ...
            m(t.redraw, !0) && this.redraw(t.animation));
        }
        function v() {
          let t = this.options;
        ...
        function A() {
          ...
          if (
            ...
            ((!c && "x" === this.zooming.type) ||
              (c && "x" === this.zooming.pinchType))
          )
            return !1;
        }
        function w(t) {
        ...
        function C(t) {
          ...
          !this.navigator &&
            !this.scroller &&
            (e.enabled || i.enabled) &&
            (g(!0, this.options.navigator, e),
            g(!0, this.options.scrollbar, i),
        ...
        return {
          compose: function (t, e, o, c) {
            if ((i.compose(t), (a = o), r.pushUnique(b, e))) {
              let t = e.prototype;
              t.callbacks.push(w),
                u(e, "afterAddSeries", f),
                u(e, "afterSetChartSize", x),
                u(e, "afterUpdate", y),
                u(e, "beforeRender", v),
                u(e, "beforeShowResetZoom", A),
                u(e, "update", C);
            }
            r.pushUnique(b, c) && u(c, "afterUpdate", E),
              r.pushUnique(b, d) && p(d().prototype.symbols, n),
              r.pushUnique(b, h) && p(l, { navigator: s });
          },
        };
      }
    ),
    i(e, "Core/Axis/ScrollbarAxis.js", [e["Core/Utilities.js"]], function (t) {
      var e;
      let { addEvent: i, defined: s, pick: n, pushUnique: o } = t;
      return (
        (function (t) {
          let e;
          let r = [];
          function a(t) {
            ...
            return {
              axisMin: e,
              axisMax: i,
              scrollMin: s(t.dataMin)
                ? Math.min(e, t.min, t.dataMin, n(t.threshold, 1 / 0))
                : e,
              scrollMax: s(t.dataMax)
                ? Math.max(i, t.max, t.dataMax, n(t.threshold, -1 / 0))
                : i,
            };
          }
          function l() {
          ...
          function h() {
            ...
            t.options &&
              ...
              i(t.scrollbar, "changed", function (e) {
                let i, n;
                let {
                    axisMin: o,
                    axisMax: r,
          ...
          function c() {
            let t, e, i;
            let { scrollMin: n, scrollMax: o } = a(this),
              r = this.scrollbar,
            ...
            if (r && h) {
              if (this.horiz)
                this.opposite || (h[1] += l),
                  r.position(
                    this.left,
                    this.top + this.height + 2 + h[1] - (this.opposite ? c : 0),
                    this.width,
                    this.height
                  ),
                  this.opposite || (h[1] += c),
                ...
                this.opposite && (h[0] += l),
                  (e = r.options.opposite
                    ...
                    ? 0
                    : c),
                  r.position(e, this.top, this.width, this.height),
                  this.opposite && (h[0] += c),
                  (t = 0);
              }
              (h[t] += r.size + (r.options.margin || 0)),
                isNaN(n) ||
                isNaN(o) ||
                !s(this.min) ||
                !s(this.max) ||
        ...
        class g {
          ...
          addEvents() {
            let t = this.options.inverted ? [1, 0] : [0, 1],
              ...
              h = [
                [i[t[0]].element, "click", this.buttonToMinClick.bind(this)],
                [i[t[1]].element, "click", this.buttonToMaxClick.bind(this)],
          ...
          buttonToMinClick(t) {
            let e = a(this.to - this.from) * u(this.options.step, 0.2);
          ...
          drawScrollbarButton(t) {
            ...
            if ((i.push(o), s.buttonsEnabled)) {
              let r = e.rect().addClass("highcharts-scrollbar-button").add(o);
          ...
          mouseMoveHandler(t) {
            ...
            this.grabbedCenter &&
              ...
              ((e = this.cursorToScrollbarPosition(i)[n] - this[n]),
              (this.hasDragged = !0),
          ...
          position(t, e, i, s) {
            let n = this.options,
              { buttonsEnabled: o, margin: r = 0, vertical: a } = n,
            ...
            this.group.show(),
              ...
              (this.yOffset = c),
              a
                ? ((this.width = this.yOffset = i = c = this.size),
                  (this.xOffset = h = 0),
                ...
                : ((this.height = s = this.size),
                  ...
                  (this.y = this.y + r)),
              this.group[l]({ translateX: t, translateY: this.y }),
          ...
          render() {
            let t = this.renderer,
              ...
              n = t.g("scrollbar").attr({ zIndex: e.zIndex }).hide().add();
            (this.group = n),
              (this.track = t
                .rect()
      ...
      function (t, e, i, s, n, o, r) {
        ...
        class M {
          ...
          drawMasks(t, e, i, s) {
            ...
            i
              ...
              this.shades.forEach((t, e) => {
                t[s]({ x: r[e], y: a[e], width: o[e], height: n[e] });
              });
          }
          renderElements() {
            let t = this,
            ...
            if (
              ...
              let i = e.handles,
                { height: n, width: l } = i;
              [0, 1].forEach((e) => {
                (t.handles[e] = o.symbol(i.symbols[e], -l / 2 - 1, 0, l, n, i)),
                  s.inverted &&
                    t.handles[e].attr({
                      rotation: 90,
          ...
          render(t, e, i, s) {
            ...
            if (((t = u(t - r / 2)), (e = u(e + r / 2)), !v(t) || !v(e))) {
              if (!h) return;
              (i = 0), (s = w(o.width, a.width));
            }
            this.left = w(o.left, n.plotLeft + b + (c ? n.plotWidth : 0));
            let M =
              (this.size =
              E =
                w(o.len, (c ? n.plotHeight : n.plotWidth) - 2 * b));
            (f = c ? C : E + 2 * b),
              (i = w(i, o.toPixels(t, !0))),
              (s = w(s, o.toPixels(e, !0))),
              (v(i) && Math.abs(i) !== 1 / 0) || ((i = 0), (s = f));
            let S = o.toValue(i, !0),
              k = o.toValue(s, !0),
              P = Math.abs(u(k - S));
            P < g
              ? this.grabbedLeft
                ...
                : this.grabbedRight && (s = o.toPixels(S + g + r, !0))
              : p(m) &&
                u(P - r) > m &&
                (this.grabbedLeft
                  ? (i = o.toPixels(k - m - r, !0))
                  : this.grabbedRight && (s = o.toPixels(S + m + r, !0))),
            ...
            l &&
              ...
              this.navigatorOptions.handles.enabled &&
                (this.drawHandle(B, 0, c, T), this.drawHandle(M, 1, c, T))),
              this.scrollbar &&
                (c
                  ? ((A = this.top - b),
                    (y =
          ...
          addMouseEvents() {
            ...
            (t.mouseMoveHandler = n =
              ...
              t.series &&
                t.series[0] &&
                s.push(
                  c(t.series[0].xAxis, "foundExtremes", function () {
            ...
            i.inverted && ((l = t.chartY), (a = this.top)),
              1 === e
                ...
                : ((u = l - a - r / 2),
                  ...
                  u !== n &&
                    ((this.fixedWidth = r),
                    p((d = s.navigatorAxis.toFixedRange(u, u + r, c, h)).min) &&
          ...
          onMouseMove(t) {
            ...
            (!t.touches || 0 !== t.touches[0].pageX) &&
              ...
              e.grabbedLeft
                ? ((e.hasDragged = !0), e.render(0, 0, l - a, e.otherHandlePos))
                : e.grabbedRight
                ? ((e.hasDragged = !0), e.render(0, 0, e.otherHandlePos, l - a))
                : e.grabbedCenter &&
                  ((e.hasDragged = !0),
              ...
              e.hasDragged &&
                e.scrollbar &&
                w(e.scrollbar.options.liveRedraw, !h && !this.chart.boosted) &&
                ((t.DOMType = t.type),
                setTimeout(function () {
                  e.onMouseUp(t);
                }, 0)));
            ...
            ((this.hasDragged && (!h || !h.hasDragged)) ||
              ...
              this.navigatorEnabled &&
                ...
                this.navigatorOptions.handles.enabled &&
                  ...
                  (this.drawHandle(i, 0, d, u), this.drawHandle(e, 1, d, u)));
          }
          removeEvents() {
            this.eventsToUnbind &&
          ...
          removeBaseSeriesEvents() {
            ...
            this.navigatorEnabled &&
              ...
              t[0].xAxis &&
                C(t[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes));
          }
          init(e) {
            let i = e.options,
              n = i.navigator || {},
            ...
            (this.handles = []),
              ...
              (this.opposite = w(n.opposite, !!(!r && e.inverted)));
            let p = this,
              g = p.baseSeries,
              m = e.xAxis.length,
              b = e.yAxis.length,
              f = (g && g[0] && g[0].xAxis) || e.xAxis[0] || { options: {} };
            if (
              ((e.isDirtyBox = !0),
              p.navigatorEnabled
                ? ((p.xAxis = new t(
                    ...
                    A(
                      ...
                      e.inverted
                        ? { offsets: [u, 0, -u, 0], width: h }
                        : { offsets: [0, -u, 0, u], height: h }
                    ),
                    "xAxis"
                  )),
                  (p.yAxis = new t(
                  ...
                  g || n.series.data
                    ...
                    : 0 === e.series.length &&
                      (p.unbindRedraw = c(e, "beforeRedraw", function () {
                        e.series.length > 0 &&
                          !p.series &&
                ...
                : ((p.xAxis = {
                    ...
                    translate: function (t, i) {
                      let s = e.xAxis[0],
                        n = s.getExtremes(),
                        o = s.len - 2 * u,
                        r = T("min", s.options.min, n.dataMin),
                        a = T("max", s.options.max, n.dataMax) - r;
                      return i ? (t * a) / o + r : (o * (t - r)) / a;
                    },
                    toPixels: function (t) {
                  ...
                  (p.xAxis.navigatorAxis.toFixedRange =
                    s.prototype.toFixedRange.bind(p.xAxis.navigatorAxis))),
              e.options.scrollbar.enabled)
            ) {
              let t = A(e.options.scrollbar, { vertical: e.inverted });
              !v(t.margin) &&
                p.navigatorEnabled &&
                (t.margin = e.inverted ? -3 : 3),
                (e.scrollbar = p.scrollbar = new o(e.renderer, t, e)),
            ...
            return (
              (t && null === i.dataMin) ||
                (e = {
                  dataMin: w(
                    n && n.min,
                    T("min", o.min, i.dataMin, s.dataMin, s.min)
                  ),
                  dataMax: w(
                    n && n.max,
                    T("max", o.max, i.dataMax, s.dataMax, s.max)
                  ),
                }),
              e
            );
          ...
          setBaseSeries(t, e) {
            ...
            (t =
              ...
              (i.series.length
                ? f(i.series, (t) => !t.options.isInternal).index
                : 0)),
            ...
            let i = this,
              ...
              r = (i.series = (i.series || []).filter((t) => {
                ...
                return (
                  !(0 > n.indexOf(e)) ||
                  (e &&
                    (C(e, "updatedData", i.updatedDataHandler),
            ...
            n &&
              ...
              n.forEach((t) => {
                ...
                (o.name = "Navigator " + n.length),
                  (d = (l = t.options || {}).navigatorOptions || {}),
                  (p.dataLabels = E(p.dataLabels)),
                  ((h = A(l, o, p, d)).pointRange = w(
                    p.pointRange,
                    d.pointRange,
                    a.plotOptions[h.type || "line"].pointRange
                  ));
                let g = d.data || p.data;
              ...
              ((c.data && !(n && n.length)) || y(c)) &&
                ...
                (c = E(c)).forEach((t, e) => {
                  (o.name = "Navigator " + (r.length + 1)),
                    ...
                    h.data &&
                      ((i.hasNavigatorData = !0), r.push(s.initSeries(h)));
                })),
          ...
          addBaseSeriesEvents() {
            ...
            e[0] &&
              ...
              e[0].eventsToUnbind.push(
                c(e[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)
              ),
              e.forEach((e) => {
                e.eventsToUnbind.push(
                  ...
                  !1 !== this.navigatorOptions.adaptToUpdatedData &&
                    e.xAxis &&
                    e.eventsToUnbind.push(
                      c(e, "updatedData", this.updatedDataHandler)
                    ),
                  e.eventsToUnbind.push(
                    c(e, "remove", function () {
                      this.navigatorSeries &&
          ...
          shouldStickToMin(t, e) {
            let i = e.getBaseSeriesMin(t.xData[0]),
              ...
              o = s.min,
              r = s.options.range;
            return !!(v(n) && v(o)) && (r && n - i > 0 ? n - i < r : o <= i);
          }
          addChartEvents() {
              ...
              [0, 1].forEach((e) => {
                ...
                if (i) {
                  let s = this.proxyProvider.addProxyElement(
                    ...
                    {
                      type: "range",
                      "aria-label": c(n, { handleIx: e, chart: t }, t),
                    }
                  );
                  (this[e ? "maxHandleProxy" : "minHandleProxy"] =
                    s.innerElement),
            ...
            this.updateNavigatorThrottleTimer &&
              ...
              (this.updateNavigatorThrottleTimer = setTimeout(
                ((t) => {
                  let e = this.chart,
                    i = e.navigator;
                  if (i && this.minHandleProxy && this.maxHandleProxy) {
                    ...
                    [
                      ...
                      let o = this.getHandleByIx(t)?.element;
                      o &&
                        b(
                          o,
                          g(e, { x: s.left + i.left + n, y: s.top + i.top }, o)
                        );
                    }),
                      t && t();
                    let r =
                        e.options.lang.accessibility?.navigator
                          .changeAnnouncement,
                      a = m(e.xAxis[0]);
                    this.announcer.announce(
                      c(r, { axisRangeDescription: a, chart: e }, e)
                    );
                  }
                }).bind(this, t),
                20
    ...
    i(
      ...
      function (t, e, i, s, n) {
        let { getPointAnnotationTexts: o } = t,
          ...
          { find: g, isNumber: m, isString: b, pick: f, defined: x } = n;
        function y(t) {
          ...
          let e = t.series,
            ...
            s = (function (t) {
              let e = t.series,
                i = e.chart,
                s = e.options.accessibility,
                n = s && s.point && s.point.valueDescriptionFormat,
                o = n || i.options.accessibility.point.valueDescriptionFormat,
                r = f(
                  e.xAxis &&
                      ...
                      let e = (function (t) {
                          ...
                          if (o) {
                            let e = o.getXDateFormat(
                              ...
                              r =
                                (s.dateFormatter && s.dateFormatter(t)) ||
                                (n.dateFormatter && n.dateFormatter(t)) ||
                                s.dateFormat ||
                                n.dateFormat ||
                                e;
                            return i.time.dateFormat(r, t.x || 0, void 0);
                          }
                        })(t),
                        i = t.series.xAxis || {},
                        s =
                        ...
                        n = x(t.id) && 0 > ("" + t.id).indexOf("highcharts-"),
                        o = "x, " + t.x;
                      return t.name || e || s || (n ? t.id : o);
                    })(t)
                  : "",
                l = {
                  point: t,
                    ...
                    let e = t.series,
                      ...
                      s =
                        (e.chart.options.accessibility &&
                          e.chart.options.accessibility.point) ||
                        {},
                      n = e.tooltipOptions || {},
                      o = s.valuePrefix || i.valuePrefix || n.valuePrefix || "",
                      r = s.valueSuffix || i.valueSuffix || n.valueSuffix || "",
                      a = void 0 !== t.value ? "value" : "y",
                      l = v(t, t[a]);
                    return t.isNull
                      ? e.chart.langFormat(
                      ...
                      ? (function (t, e, i) {
                          let s = e || "",
                            n = i || "",
                            o = function (e) {
                              let i = v(t, f(t[e], t.options[e]));
                              return void 0 !== i ? e + ": " + s + i + n : i;
                            },
                            r = t.series.pointArrayMap;
                          return r.reduce(function (t, e) {
                            let i = o(e);
                            return i ? t + (t.length ? ", " : "") + i : t;
                          }, "");
                        })(t, o, r)
                      : o + l + r;
                  })(t),
        ...
        function C(t) {
          let e = t.chart,
            ...
            d =
              e.langFormat("accessibility.series.summary." + t.type + h, l) ||
              e.langFormat("accessibility.series.summary.default" + h, l),
            u =
              (n("yAxis") ? " " + a + "." : "") +
              (n("xAxis") ? " " + r + "." : ""),
            p = f(
            ...
            s &&
              ...
              (function (t) {
                let e = (function (t) {
                  ...
                  i = (function (t) {
                    ...
                    return !!(
                      t.points &&
                      (t.points.length < +i.pointNavigationEnabledThreshold ||
                        !1 === i.pointNavigationEnabledThreshold)
                    );
                  })(t),
                  s = t.chart.options.accessibility.point.describeNull;
                (e || i) &&
                  t.points.forEach((i) => {
                    let n =
                        ...
                        ((function (t) {
                          let e = t.series,
                            ...
                            s = e && e.is("sunburst"),
                            n = t.isNull,
                            o = i && i.options.accessibility.point.describeNull;
                          return n && !s && o;
                        })(i) &&
                          (function (t) {
                            let e = t.series,
                              ...
                              s = i && i.graphic,
                              n = s ? s.parentGroup : e.graph || e.group,
                              o = i
                                ? {
                                    x: f(t.plotX, i.plotX, 0),
                                    y: f(t.plotY, i.plotY, 0),
                                  }
                                : { x: f(t.plotX, 0), y: f(t.plotY, 0) },
                              r = (function (t, e) {
                                let i = t.series.chart.renderer,
                                  s = i.rect(e.x, e.y, 1, 1);
                                return (
                                  s.attr({
                              ...
                              let i = t.series,
                                ...
                                o = p(
                                  (b(s.descriptionFormat) &&
                                    c(s.descriptionFormat, t, i.chart)) ||
                                    s.descriptionFormatter?.(t) ||
                                    (b(n.descriptionFormat) &&
                                      c(n.descriptionFormat, t, i.chart)) ||
              ...
              (function (t) {
                let e = t.chart,
                  ...
                  n = e.series.length > 1,
                  o = e.options.accessibility.series.describeSingleSeries,
                  r = (t.options.accessibility || {}).exposeAsGroupOnly;
                ...
                ? (function (t, e) {
                    ...
                    i.exposeAsGroupOnly
                      ...
                      e.setAttribute("tabindex", "-1"),
                      t.chart.styledMode || (e.style.outline = "none"),
                      e.setAttribute(
                        "aria-label",
                        p(
                          (s.series.descriptionFormatter &&
                            s.series.descriptionFormatter(t)) ||
                            C(t),
    ...
    i(
      ...
      function (t, e, i, s, n, o) {
        let { addEvent: r, defined: a } = e,
          { getChartTitle: l } = s,
          {
            defaultPointDescriptionFormatter: h,
            defaultSeriesDescriptionFormatter: c,
          } = o;
        function d(t) {
        ...
        class u {
          ...
          onSeriesAdded(t) {
            d(this.chart) &&
              ...
              (this.dirty.newSeries = a(this.dirty.newSeries) ? void 0 : t));
          }
          announceDirtyData() {
            let t = this.chart,
              e = this;
            ...
            if (n.enabled) {
              let s = +new Date(),
                ...
                a = (function (t, e) {
                  let i = (t || [])
                    .concat(e || [])
                    .reduce((t, e) => ((t[e.name + e.index] = e), t), {});
              ...
              l &&
                ...
                (this.queuedAnnouncement = { time: s, message: l, series: a }),
          ...
          buildAnnouncementMessage(e, i, s) {
            ...
            let r = t.charts && t.charts.length > 1 ? "Multiple" : "Single",
              a = i
                ? "newSeriesAnnounce" + r
                : s
                ? "newPointAnnounce" + r
            ...
            return n.langFormat("accessibility.announceNewData." + a, {
              chartTitle: d,
              seriesDesc: i ? c(i) : null,
              pointDesc: s ? h(s) : null,
              point: s,
              series: i,
            });
          }
          ...
          (function (t) {
            function i(t) {
              ...
              i &&
                i.chart === e &&
                d(e) &&
                (i.dirty.newPoint = a(i.dirty.newPoint) ? void 0 : t.point);
            }
            function s() {
              let t = this.chart,
              ...
              e &&
                ...
                d(t) &&
                ((e.dirty.hasDirty = !0),
                (e.dirty.allSeries[this.name + this.index] = this));
            }
            (t.composedMembers = []),
              (t.compose = function (n) {
                e.pushUnique(t.composedMembers, n) &&
                  (r(n, "addPoint", i), r(n, "updatedData", s));
              });
          })(u || (u = {})),
          u
        );
        ...
        return class {
          ...
          updateTarget(t, e) {
            ...
            r(this.innerElement, l(s ? { "aria-label": s } : {}, i)),
              this.eventProvider.removeAddedEvents(),
              this.addProxyEventsToElement(this.innerElement, t.click),
          ...
          updateCSSClassName() {
            let t = (t) => t.indexOf("highcharts-no-tooltip") > -1,
              ...
              s = t((i && i.className) || ""),
              n = this.getTargetAttr(this.target.click, "class") || "",
              o = t(n);
          ...
          addProxyEventsToElement(t, e) {
            [
              ...
              this.eventProvider.addEvent(
                ...
                (t) => {
                  let i = s ? d(t) : c(t);
                  e && h(e, i), t.stopPropagation(), s || t.preventDefault();
                },
                { passive: !1 }
              );
            });
          ...
          getTargetAttr(t, e) {
            return t.element ? t.element.getAttribute(e) : t.getAttribute(e);
          }
        };
      }
    ),
        ...
        return class {
          ...
          addGroup(t, e = "div", i) {
            ...
            return (
              i && i.role && "div" !== e
                ? (s =
                    this.domElementProvider.createElement("div")).appendChild(o)
                : (s = o),
              (s.className =
          ...
          updateGroupOrder(t) {
            if (((this.groupOrder = t.slice()), this.isDOMOrderGroupOrder()))
              return;
          ...
          clearGroup(t) {
            let e = this.groups[t];
            if (!e)
              throw Error("ProxyProvider.clearGroup: Invalid group key " + t);
          ...
          updateGroupProxyElementPositions(t) {
            let e = this.groups[t];
            e && e.proxyElements.forEach((t) => t.refreshPosition());
          }
          destroy() {
            this.domElementProvider.destroyCreatedElements();
          }
          createProxyPosContainer(t) {
            ...
            return (
              ...
              (e.className =
                "highcharts-a11y-proxy-container" + (t ? "-" + t : "")),
              l(e, { top: "0", left: "0" }),
              this.chart.styledMode ||
          ...
          updatePosContainerPositions() {
            ...
            t.container.insertBefore(
              ...
              t.container.insertBefore(this.beforeChartProxyPosContainer, e),
    ...
    i(
      ...
      function (t, e, i) {
        let s;
        let { defaultOptions: n, setOptions: o } = t,
          {
            addEvent: r,
            defined: a,
            extend: l,
        ...
        function m() {
          ...
          let a = u(this.dataMin, Number.MIN_VALUE);
          return (
            c(t) || (t = a),
            t <= a &&
              ((t = a),
          ...
          if (o) {
            ...
            e ||
              p.push([
                t,
                [
                  r(t.xAxis[0], "afterSetExtremes", function (t) {
        ...
        function w(t) {
          ...
          if (
            ...
            x(this);
            let t =
              (i && i.verticalAlign) || (r.options && r.options.verticalAlign);
            r.options.floating ||
              ("bottom" === t
                ? (this.extraBottomMargin = !0)
                : "middle" === t || (this.extraTopMargin = !0)),
              (this.extraBottomMargin !== n || this.extraTopMargin !== o) &&
                (this.isDirtyBox = !0);
          }
        }
        return {
          compose: function (t, a, h) {
            if (
              ((s = h),
              i.pushUnique(g, t) && (t.prototype.minFromRange = m),
              i.pushUnique(g, a))
            ) {
              r(a, "afterGetContainer", b),
                r(a, "beforeRender", f),
                r(a, "destroy", y),
                r(a, "getMargins", v),
                r(a, "render", A),
            ...
            i.pushUnique(g, o) &&
              (l(n, { rangeSelector: e.rangeSelector }), l(n.lang, e.lang));
          },
        };
      }
    ),
        ...
        class w {
          ...
          clickButton(e, i) {
            let s = this.chart,
              ...
              o = s.xAxis[0],
              r = (s.scroller && s.scroller.getUnionExtremes()) || o || {},
              l = n.type,
              h = n.dataGrouping,
              d = r.dataMin,
              u = r.dataMax,
            ...
            if (null !== d && null !== u) {
              if (
                ...
                (b = Math.min((p = Math.max(b - x, d)) + x, u)), (M = !1);
              else if ("ytd" === l) {
                if (o)
                  (void 0 === u || void 0 === d) &&
                    ((d = Number.MAX_VALUE),
                    ...
                    s.series.forEach((t) => {
                      ...
                      e &&
                        ((d = Math.min(e[0], d)),
                        (u = Math.max(e[e.length - 1], u)));
                    }),
                    (i = !1)),
                    (p = v =
                      (T = this.getYTDExtremes(u, d, s.time.useUTC)).min),
                    (b = T.max);
                else {
          ...
          init(t) {
            ...
            (e.chart = t),
              ...
              (e.buttonOptions = s),
              (this.eventsToUnbind = []),
              this.eventsToUnbind.push(a(t.container, "mousedown", o)),
              ...
              this.eventsToUnbind.push(
                a(t, "load", function () {
                  t.xAxis &&
                    t.xAxis[0] &&
                    a(t.xAxis[0], "setExtremes", function (i) {
          ...
          updateButtonStates() {
            let t = this,
              ...
              r = 24 * 36e5,
              a = (e.scroller && e.scroller.getUnionExtremes()) || s,
              l = a.dataMin,
              h = a.dataMax,
              c = t.getYTDExtremes(h, l, e.time.useUTC),
              d = c.min,
              u = c.max,
              p = t.selected,
              g = t.options.allButtonsEnabled,
              b = t.buttons,
              f = m(p);
            t.buttonOptions.forEach((e, a) => {
              let c = e._range,
                ...
                S = c === n;
              ("month" === m || "year" === m) &&
              n + 36e5 >= { month: 28, year: 365 }[m] * r * x - v &&
              n - 36e5 <= { month: 31, year: 366 }[m] * r * x + v
                ? (S = !0)
                : "ytd" === m
                ? ((S = u - d + v === n), (T = !A))
                : "all" === m &&
                  ((S = s.max - s.min >= h - l), (M = !A && f && S));
              let k = !g && (w || C || M || o),
                P = (A && S) || (S && !f && !T) || (A && t.frozenStates);
              k ? (E = 3) : P && ((f = !0), (E = 2)),
                y.state !== E &&
                  (y.setState(E),
                  i &&
                    ((i.options[a + 1].disabled = k),
                    2 === E && (i.selectedIndex = a + 1)),
                  0 === E && p === a && t.setSelected());
            });
          }
          ...
          setInputValue(t, e) {
            ...
            if (n) {
              ...
              if (c(e)) {
                let t = r;
                c(t) && n.setAttribute("data-hc-time-previous", t),
                  n.setAttribute("data-hc-time", e),
                  (r = e);
              }
              (n.value = s.dateFormat(
                this.inputTypeFormats[n.type] || i.inputEditDateFormat,
                r
              )),
                o && o.attr({ text: s.dateFormat(i.inputDateFormat, r) });
            }
          }
          ...
          showInput(t) {
            ...
            if (i && e && this.inputGroup) {
              let t = "text" === i.type,
                { translateX: s = 0, translateY: n = 0 } = this.inputGroup,
              ...
              h(i, {
                ...
                t && l
                  ? h(i, { left: s + o + "px", top: n + "px" })
                  : h(i, {
                      left:
                        Math.min(
                          Math.round(o + s - (i.offsetWidth - r) / 2),
                          this.chart.chartWidth - i.offsetWidth
                        ) + "px",
                      top: n - (i.offsetHeight - a) / 2 + "px",
                    });
            }
          }
          hideInput(t) {
            let e = "min" === t ? this.minInput : this.maxInput;
            e &&
              h(e, { top: "-9999em", border: 0, width: "1px", height: "1px" });
          }
          defaultInputDateParser(t, e, s) {
            let n = t.split("/").join("-").split(" ").join("T");
            if ((-1 === n.indexOf("T") && (n += "T00:00"), e)) n += "Z";
            else {
              var o;
              if (
                i.isSafari &&
            ...
            return s && e && m(r) && (r += s.getTimezoneOffset(r)), r;
          }
          drawInput(t) {
            ...
            function f() {
              let { maxInput: i, minInput: s } = o,
                n = e.xAxis[0],
                r = (e.scroller && e.scroller.getUnionExtremes()) || n,
                a = r.dataMin,
                l = r.dataMax,
                h = o.getInputValue(t);
              h !== Number(A.getAttribute("data-hc-time-previous")) &&
                m(h) &&
                ...
                g && i && m(a)
                  ...
                  : s &&
                    ...
                    (h < Number(s.getAttribute("data-hc-time"))
                      ...
                      : h > l && (h = l)),
                void 0 !== h &&
                  n.setExtremes(g ? h : n.min, g ? n.max : h, void 0, void 0, {
                    trigger: "rangeSelectorInput",
                  }));
            }
            let x = u[g ? "rangeSelectorFrom" : "rangeSelectorTo"] || "",
              y = c
                .label(x, 0)
                .addClass("highcharts-range-label")
                .attr({ padding: x ? 2 : 0, height: x ? d.inputBoxHeight : 0 })
                .add(n),
              v = c
                .label("", 0)
            ...
            e.styledMode ||
              v.attr({ stroke: d.inputBoxBorderColor, "stroke-width": 1 }),
              v.add(n);
            let A = l(
              "input",
            ...
            return (
              ...
              (A.onkeydown = (t) => {
                (w = !0), (38 === t.keyCode || 40 === t.keyCode) && f();
              }),
              (A.onkeyup = () => {
                w = !1;
              }),
          ...
          getYTDExtremes(t, e, i) {
            let s = this.chart.time,
              ...
              a = n.getTime();
            return { max: Math.min(t || a, a), min: Math.max(e, r) };
          }
          render(t, e) {
            let i = this.chart,
              s = i.renderer,
            ...
            if (!1 !== r.enabled) {
              if (
                ...
                n.parentNode && n.parentNode.insertBefore(this.div, n),
                h)
              ) {
                ...
                if (this.inputGroup) {
                  ...
                  [
                    ...
                    if (e) {
                      ...
                      i && (e.attr({ x: t }), (t += i + r.inputSpacing));
                    }
                  });
                }
              }
          ...
          renderButtons() {
            ...
            a(u, "touchstart", () => {
              ...
              this.buttonOptions.forEach((e, i) => {
                l("option", { textContent: e.title || e.text }, void 0, u),
                  (t[i] = o
                    .button(
                      e.text,
                      0,
          ...
          alignElements() {
            let {
              ...
              { buttonPosition: h, inputPosition: c, verticalAlign: d } = o,
              u = (t, e) =>
                l &&
            ...
            if (s && h && c) {
              ...
              if (t) {
                if ((this.positionButtons(), !this.initialButtonGroupWidth)) {
                  ...
                  r && (t += r.getBBox().width + 5),
                    e.forEach((i, s) => {
                      (t += i.width || 0),
                        s !== e.length - 1 && (t += o.buttonSpacing);
                    }),
                    (this.initialButtonGroupWidth = t);
                }
                (p -= i.spacing[3]), this.updateButtonStates();
                let n = u(t, h);
                this.alignButtonGroup(n), (s.placed = t.placed = i.hasLoaded);
              }
              let l = 0;
              n &&
                ((l = u(n, c)),
                "left" === c.align
                  ? (a = p)
                  : "right" === c.align && (a = -Math.max(i.axisOffset[1], -l)),
                n.align(
                  {
                    y: c.y,
              ...
              if ("bottom" === d) {
                let t = i.legend && i.legend.options,
                  e =
                    ...
                    t.enabled &&
                    !t.floating
                      ? i.legend.legendHeight + y(t.margin, 10)
                      : 0;
                b =
                  g -
                  (m = m + e - 20) -
              ...
              "top" === d
                ? (o.floating && (b = 0),
                  i.titleOffset && i.titleOffset[0] && (b = i.titleOffset[0]),
              ...
              let { minInput: f, maxInput: x, dropdown: v } = this;
              o.inputEnabled &&
                f &&
                x &&
          ...
          alignButtonGroup(t, e) {
            let { chart: i, options: s, buttonGroup: n, buttons: o } = this,
              { buttonPosition: r } = s,
            ...
            "right" === r.align
              ...
              n &&
                n.align(
                  {
                    y: r.y,
                    width: y(e, this.initialButtonGroupWidth),
                    align: r.align,
                    x: l,
                  },
                  !0,
          ...
          positionButtons() {
            ...
            s &&
              "hidden" !== s.visibility &&
              (s[n]({ x: y(r + o.x, r) }), (a += o.x + s.getBBox().width + 5));
          ...
          handleCollision(t) {
            let { chart: e, buttonGroup: i, inputGroup: s } = this,
              ...
              l = (e) => {
                if (s && i) {
                  ...
                  return (
                    l + e > o && o + a > l && n.y < r.y + s.getBBox().height
                  );
                }
                return !1;
              },
              h = () => {
                s &&
                  ...
                  s.attr({
                    translateX:
                      s.alignAttr.translateX + (e.axisOffset[1] >= -t ? 0 : -t),
                    translateY:
            ...
            s && i
              ? r.align === n.align || l(this.initialButtonGroupWidth + 20)
                ? "responsive" === o
                  ? (this.collapseButtons(t), l(a()) && h())
                  : h()
          ...
          collapseButtons(t) {
            let {
              ...
              l = (t) => ({
                text: t ? `${t} ▾` : "▾",
                width: "auto",
                paddingLeft: y(o.buttonTheme.paddingLeft, a.padding, 8),
                paddingRight: y(o.buttonTheme.paddingRight, a.padding, 8),
              });
            r && r.hide();
            let h = !1;
            i.forEach((t, i) => {
              ...
              e.forEach((e, s) => {
                ...
                n.show(),
                  n.attr({
                    ...
                    paddingLeft: y(i.buttonTheme.paddingLeft, "unset"),
                    paddingRight: y(i.buttonTheme.paddingRight, "unset"),
                  }),
          ...
          hideDropdown() {
            let { dropdown: t } = this;
            t &&
              (h(t, { top: "-9999em", width: "1px", height: "1px" }),
              ...
              f(
                ...
                function (e, i) {
                  e &&
                    ...
                    (e instanceof n
                      ? e.destroy()
                      : e instanceof window.HTMLElement && u(e)),
    ...
    i(
      ...
      function (t, e, i, s, n, o) {
        let { unhideChartElementFromAT: r, getAxisRangeDescription: a } = i,
          { addEvent: l, attr: h } = o;
        class c extends e {
          constructor() {
            super(...arguments), (this.announcer = void 0);
          ...
          updateSelectorVisibility() {
            ...
            e && e.hasVisibleDropdown && i
              ? (r(t, i), s.forEach((t) => n(t.element)))
              : (i && n(i), s.forEach((e) => r(t, e.element)));
          }
          setDropdownAttrs() {
            let t = this.chart,
            ...
            if (e) {
              ...
              e.setAttribute("aria-label", i), e.setAttribute("tabindex", -1);
            }
          }
          setRangeButtonAttrs(t) {
            h(t.element, { tabindex: -1, role: "button" });
          }
          setRangeInputAttrs(t, e) {
            let i = this.chart;
            h(t, { tabindex: -1, "aria-label": i.langFormat(e, { chart: i }) });
          }
          ...
          onInputKbdMove(t) {
            ...
            if (s > 1 || s < 0) {
              if (e.accessibility)
                return (
                  (e.accessibility.keyboardNavigation.exiting = !0),
          ...
          initDropdownNav() {
            ...
            e &&
              ...
              this.removeDropdownKeydownHandler &&
                this.removeDropdownKeydownHandler(),
              (this.removeDropdownKeydownHandler = l(i, "keydown", (e) => {
                let i = (e.which || e.keyCode) === this.keyCodes.tab,
                  s = t.accessibility;
                i &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  s &&
                    ...
                    s.keyboardNavigation.move(e.shiftKey ? -1 : 1)));
              })));
          }
            ...
            return new n(t, {
              ...
              init: function (e) {
                ...
                if (s && s.hasVisibleDropdown) i.initDropdownNav();
                  ...
                  t.highlightRangeSelectorButton(e > 0 ? 0 : i);
                }
              },
              terminate: function () {
            ...
            return new n(t, {
              ...
              validate: function () {
                return !!(
                  ...
                  "hidden" !==
                    t.rangeSelector.inputGroup.element.style.visibility &&
        ...
        return (
          (function (e) {
            ...
            e.compose = function (e, r) {
              if (o.pushUnique(i, e)) {
                let t = e.prototype;
                t.highlightRangeSelectorButton = s;
              }
              o.pushUnique(i, r) && l(t, "afterBtnClick", n);
            };
          })(c || (c = {})),
          c
        );
      ...
      function (t) {
        ...
        return (
          (function (e) {
            ...
            function a(t) {
              return !!(t._hasPointMarkers && t.points && t.points.length);
            }
            function l() {
              this.chart.styledMode &&
                (this.markerGroup &&
            ...
            function c() {
              ...
              (function (t) {
                ...
                ? (t.marker &&
                    !1 === t.marker.enabled &&
                    ((this.a11yMarkersForced = !0), o(this.options)),
                  a(this) &&
                    (function (t) {
                      let e = t.points.length;
                      for (; e--; ) {
                        let i = t.points[e],
                          n = i.options,
                          a = i.hasForcedA11yMarker;
                        if ((delete i.hasForcedA11yMarker, n.marker)) {
                          let t = a && 0 === r(n);
                          n.marker.enabled && !t
                            ? (s(!0, n.marker, {
                                states: { normal: { opacity: r(n) || 1 } },
                              }),
                              (i.hasForcedA11yMarker = !1))
                            : !1 === n.marker.enabled &&
                              (o(n), (i.hasForcedA11yMarker = !0));
                        }
                      }
                    })(this))
                : this.a11yMarkersForced &&
                  ...
                  (function (t) {
                    ...
                    if (e) {
                      let i =
                        e.states && e.states.normal && e.states.normal.opacity;
                      t.userOptions &&
                        t.userOptions.marker &&
                        (t.userOptions.marker.enabled = !0),
                        t.update({
                          marker: {
                            enabled: e.enabled,
    ...
    i(
      ...
      function (t, e, i, s, n, o, r, a) {
        let { seriesTypes: l } = i,
          ...
          { getPointFromXY: u, getSeriesFromName: p, scrollAxisToPoint: g } = a;
        function m(t) {
          let e = t.index,
            i = t.series.points,
            s = i.length;
        ...
        function b(t) {
          ...
          return (
            ...
            (i.pointNavigationEnabledThreshold &&
              +i.pointNavigationEnabledThreshold <= t.points.length)
          );
        }
        function f(t) {
          let e = t.series.chart.options.accessibility,
            i =
              t.options.accessibility && !1 === t.options.accessibility.enabled;
          return (
            (t.isNull &&
          ...
          for (let t = 0; t < i; ++t)
            if (!b(e[t])) {
              let i = (function (t) {
                let e = t.points || [],
                  i = e.length;
                for (let t = 0; t < i; ++t) if (!f(e[t])) return e[t];
                return null;
              })(e[t]);
              if (i) return i;
            }
        ...
        class A {
          ...
          onDrillupAll() {
            ...
            let e = this.lastDrilledDownPoint,
              i = this.chart,
              s = e && p(i, e.seriesName);
            e && s && c(e.x) && c(e.y) && (t = u(s, e.x, e.y)),
              (t = t || x(i)),
            ...
            return new o(i, {
              keyCodeMap: [
                ...
                [
                  [e.end],
                  function () {
                    return y(i), this.response.success;
                  },
                ],
                [
                  [e.pageDown, e.pageUp],
                  function (t) {
                    return (
                      i.highlightAdjacentSeries(t === e.pageDown),
                      this.response.success
                    );
                  },
                ],
          ...
          onHandlerInit(t) {
            ...
            return (
              i.seriesNavigation.rememberPointFocus && e.highlightedPoint
          ...
          onSeriesDestroy(t) {
            let e = this.chart,
              i = e.highlightedPoint && e.highlightedPoint.series === t;
            i &&
          ...
          (function (t) {
            ...
            function i(t) {
              ...
              if (n) {
                if (
                  ...
                  (i = r[o + (t ? 1 : -1)]) ||
                    !e ||
                    (i = e.points[t ? 0 : e.points.length - 1]),
                  !i)
                )
                  return !1;
            ...
            function s(t) {
              ...
              return (
                ...
                (this.series.forEach((n) => {
                  b(n) ||
                    n.points.forEach((o) => {
                      if (!c(o.plotY) || !c(o.plotX) || o === e) return;
            ...
            function o(t) {
              ...
              return this.highlightedPoint
                ? !!(
                    (e = this.series[n.series.index + (t ? -1 : 1)]) &&
                    (i = (function (t, e, i, s) {
                      let n = 1 / 0,
                        o,
                        r,
                        a,
                        l = e.points.length,
                        h = (t) => !(c(t.plotX) && c(t.plotY));
                      if (!h(t)) {
                        for (; l--; )
                          !h((o = e.points[l])) &&
                            (a =
                              (t.plotX - o.plotX) * (t.plotX - o.plotX) * 4 +
                              (t.plotY - o.plotY) * (t.plotY - o.plotY) * 1) <
                              n &&
                            ((n = a), (r = l));
                        return c(r) ? e.points[r] : void 0;
                      }
                    })(n, e, 0))
                  ) &&
                    (b(e)
                      ? (i.highlight(), (s = this.highlightAdjacentSeries(t)))
                        ? s
                        : (n.highlight(), !1)
                      : (i.highlight(), i.series.highlightNextValidPoint()))
                : ((e = t ? this.series && this.series[0] : o),
                  !!(i = t ? e && e.points && e.points[0] : r) &&
                    i.highlight());
            }
            function r(t = !0) {
              ...
              !this.isNull && t
                ...
                this.graphic &&
                  ...
                  !t && e.focusElement && e.focusElement.removeFocusBorder()),
                (e.highlightedPoint = this);
              let s = i?.getBoundingClientRect().top;
              if (i && s && s < 0) {
                let t = window.scrollY;
                window.scrollTo({ behavior: "smooth", top: t + s });
              }
              return this;
            }
            function a() {
              let t = this.chart.highlightedPoint,
                e = (t && t.series) === this ? m(t) : 0,
                i = this.points,
                s = i.length;
              if (i && s) {
                for (let t = e; t < s; ++t)
                  if (!f(i[t])) return i[t].highlight();
                for (let t = e; t >= 0; --t)
                  if (!f(i[t])) return i[t].highlight();
              }
              return !1;
            }
            t.compose = function (t, h, c) {
              if (n.pushUnique(e, t)) {
                let e = t.prototype;
                (e.highlightAdjacentPoint = i),
                  (e.highlightAdjacentPointVertical = s),
                  (e.highlightAdjacentSeries = o);
              }
              if (n.pushUnique(e, h)) {
                let t = h.prototype;
                t.highlight = r;
              ...
              if (n.pushUnique(e, c)) {
                let t = c.prototype;
                (t.keyboardMoveVertical = !0),
                  ["column", "gantt", "pie"].forEach((t) => {
                    l[t] && (l[t].prototype.keyboardMoveVertical = !1);
                  }),
                  (t.highlightNextValidPoint = a);
              }
            };
          })(A || (A = {})),
          A
        ...
        return class extends t {
          ...
          updateProxyOverlays() {
            ...
            if (
              ...
              t.drillUpButton && t.breadcrumbs && t.breadcrumbs.list)
            ) {
              let e = t.breadcrumbs.list[t.breadcrumbs.list.length - 1];
              this.createZoomProxyButton(
                t.drillUpButton,
                "drillUpProxyButton",
            ...
            return new s(r, {
              keyCodeMap: [
                [
                  ...
                  function (t, e) {
                    let i =
                      (t === n.tab && e.shiftKey) || t === n.left || t === n.up;
              ...
              init: function () {
                r.setFocusToElement(r[t].box, o[e].innerElement);
              },
            });
          }
          getKeyboardNavigation() {
        ...
        return {
          isHighContrastModeActive: function () {
            ...
            if (i && s.getComputedStyle) {
              ...
              let i = (t.currentStyle || s.getComputedStyle(t)).backgroundImage;
      ...
      function (t) {
        ...
        function s(t, e, s) {
          let n = t,
            o,
            r = 0;
          for (; r < e.length - 1; ++r) n = n[(o = e[r])] = i(n[o], {});
          n[e[e.length - 1]] = s;
        }
        function n(t, i, n, o) {
          function r(t, e) {
        ...
        return function (t) {
          (function (t) {
            ...
            ["description", "typeDescription"].forEach(function (n) {
              i[n] &&
                ((s[n] = i[n]),
                e(32, !1, t, { [`chart.${n}`]: `use accessibility.${n}` }));
            });
          })(t),
            (function (t) {
            ...
            n(t, ["lang", "accessibility"], ["lang", "accessibility"], {
    ...
    i(
      ...
      function (
        ...
        class P {
          ...
          init(t) {
            if (((this.chart = t), !C.addEventListener)) {
              (this.zombie = !0),
                (this.components = {}),
          ...
          getComponentOrder() {
            ...
            let t = Object.keys(this.components).filter((t) => "series" !== t);
          ...
          update() {
            let t = this.components,
              e = this.chart,
              i = e.options.accessibility;
            M(e, "beforeA11yUpdate"), (e.types = this.getChartTypes());
          ...
          destroy() {
            ...
            Object.keys(e).forEach(function (t) {
              ...
              t.announcerContainer && k(t.announcerContainer),
        ...
        return (
          (function (t) {
            ...
            function a(t) {
              ...
              e &&
                ...
                S(!0, this.options.accessibility, e),
                this.accessibility &&
            ...
            (t.i18nFormat = n.i18nFormat),
              (t.compose = function (t, b, f, x, y, v) {
                if (
                  (l.compose(t),
                  u.compose(x),
                  h.compose(t, b),
                  ...
                  let e = t.prototype;
                  (e.updateA11yEnabled = d),
                    E(t, "destroy", s),
                    E(t, "render", o),
                    E(t, "update", a),
                    ["addSeries", "init"].forEach((e) => {
                      E(t, e, function () {
                        this.a11yDirty = !0;
                      });
                    }),
                    ["afterApplyDrilldown", "drillupall"].forEach((e) => {
                      E(t, e, function () {
                        let t = this.accessibility;
                        t && !t.zombie && t.update();
                      });
                ...
                i.pushUnique(e, f) && E(f, "update", p),
                  i.pushUnique(e, x) &&
                    ["update", "updatedData", "remove"].forEach((t) => {
                      E(x, t, function () {
          ...
          S(!0, w, y, { accessibility: { highContrastTheme: x }, lang: v }),
          P
        );
      }
    ),
