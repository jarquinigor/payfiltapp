  ...
  return (function (t) {
          ...
          function t(e, n) {
            ...
            i(e),
              ...
              (this.config = r.extend(
                p.getGlobalConfig(),
                n.cluster ? p.getClusterConfig(n.cluster) : {},
                n
              )),
              ...
              this.config.disableStats ||
                (this.timelineSender = d["default"].createTimelineSender(
                  this.timeline,
                  {
            ...
            (this.connection = d["default"].createConnectionManager(
              ...
              this.connection.bind("connected", function () {
                l.subscribeAll(),
                  l.timelineSender &&
                    l.timelineSender.send(l.connection.isEncrypted());
              }),
          ...
          return (
            ...
            (t.prototype.connect = function () {
              if (
                ...
                this.timelineSenderTimer = new l.PeriodicTimer(
                  6e4,
                  function () {
                    e.send(t);
                  }
        ...
        r = {
          debug: function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e - 0] = arguments[e];
            o["default"].log &&
              o["default"].log(i.stringify.apply(this, arguments));
          },
          warn: function () {
            for (var t = [], e = 0; e < arguments.length; e++)
              t[e - 0] = arguments[e];
          ...
          switch (typeof t) {
            case "object":
              ...
              if (
                ...
                for (a = [], r = 0; r < t.length; r += 1)
                  a[r] = i(t[r], o + "[" + r + "]");
              else {
                a = {};
                for (s in t)
                  Object.prototype.hasOwnProperty.call(t, s) &&
                    (a[s] = i(t[s], o + "[" + JSON.stringify(s) + "]"));
              }
              return a;
            case "number":
            case "string":
    ...
    function (t, e, n) {
      ...
      var u = {
        ...
        p = { ws: a, xhr_streaming: l, xhr_polling: h };
          ...
          return (
              ...
              try {
                return (
                  h["default"]
                    .createSocketRequest(
                      "POST",
                      r(o(this.location, this.session))
                    )
                    .start(t),
                  !0
                );
            ...
            (t.prototype.onOpen = function (t) {
              this.readyState === u["default"].CONNECTING
                ? (t &&
                    t.hostname &&
                    (this.location.base = s(this.location.base, t.hostname)),
            ...
            (t.prototype.openStream = function () {
              var t = this;
              (this.stream = h["default"].createSocketRequest(
                "POST",
                r(this.hooks.getReceiveURL(this.location, this.session))
              )),
      ...
      function c(t, e) {
        if (o(t[0])) {
          ...
          if (t.length > 1) {
            ...
            var i = [l.extend({}, e)].concat(
              l.map(t.slice(1), function (t) {
        ...
        C = {
          ...
          def_transport: function (t, e, n, i, o, r) {
            ...
            var a,
              c = !(
                (t.enabledTransports &&
                  l.arrayIndexOf(t.enabledTransports, e) === -1) ||
                (t.disabledTransports &&
                  l.arrayIndexOf(t.disabledTransports, e) !== -1)
              );
            a = c
              ? new d["default"](
                  e,
                  i,
                  r ? r.getAssistant(s) : s,
                  l.extend(
                    {
                      key: t.key,
          ...
          cached: i(function (t, e, n) {
            return new g[
              "default"
            ](n, t.Transports, { ttl: e, timeline: t.timeline, encrypted: t.encrypted });
          }),
        ...
        o = (function () {
          ...
          return (
            (t.prototype.getAssistant = function (t) {
              return i["default"].createAssistantToTheTransportManager(
                this,
                t,
                {
            ...
            (t.prototype.bindListeners = function () {
              ...
              (this.onMessage = function (e) {
                ...
                try {
                  ...
                  return (
                    t.finish("error", { error: i }), void t.transport.close()
                  );
                }
                "connected" === n.action
                  ? t.finish("connected", {
        ...
        o = (function () {
          ...
          return (
            ...
            (t.prototype.authorize = function (e, n) {
              return (
                (t.authorizers =
                  t.authorizers || i["default"].getAuthorizers()),
    ...
    function (t, e, n) {
      ...
      function i(t, e) {
        return 0 === t.indexOf("private-")
          ? r["default"].createPrivateChannel(t, e)
          : 0 === t.indexOf("presence-")
          ? r["default"].createPresenceChannel(t, e)
          : r["default"].createChannel(t, e);
      }
      var o = n(9),
        r = n(42),
        s = (function () {
          ...
          return (
            (t.prototype.add = function (t, e) {
              return (
                this.channels[t] || (this.channels[t] = i(t, e)),
                this.channels[t]
              );
            }),
                    ...
                    ? (s(n),
                      c.length > 0
                        ? ((h = a["default"].now()),
                          (p = c.pop().connect(t, f)))
                        : e(i))
                    : (r(n, o.transport.name, a["default"].now() - h),
                      e(null, o));
                });
              return {
                abort: function () {
